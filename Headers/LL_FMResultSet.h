...
@class LL_FMDatabase, LL_FMStatement, NSMutableDictionary, NSString;

@interface LL_FMResultSet : NSObject
{
    LL_FMDatabase *_parentDB;
    LL_FMStatement *_statement;
    NSString *_query;
    NSMutableDictionary *_columnNameToIndexMap;
}

+ (id)resultSetWithStatement:(id)arg1 usingParentDatabase:(id)arg2;
@property(retain) LL_FMStatement *statement; // @synthesize statement=_statement;
