...
@interface BMDataSourceController : NSObject <UITableViewDataSource>
{
    NSArray *_items;
...
- (id)initWithItems:(id)arg1 cellIdentifier:(id)arg2 configureCellBlock:(CDUnknownBlockType)arg3 tableView:(id)arg4;
